...
def CESutility_valid(consumed_good1, consumed_good2, degree_complements: float) -> float: # expected input for the goods? (-1)
...
def CESutility_in_budget(consumed_good1, consumed_good2, degree_complements: float, p_x, p_y, w) -> float: # unexpected indent (-1)
...
def logit_like(y_i, x_i, beta0, beta1): # missing expected input/output (-2)
# indention issues (-1)
    ...
    """
    # missing expected return values for first two examples (-1)
